        ...
        >
            <Box sx={{ backgroundColor: 'primary.main' }}>
                <Stack direction={'row'} sx={{ justifyContent: 'space-between', px: 2, py: 2, alignItems: 'center' }}>
                    <Typography sx={{ color: 'secondary.contrastText' }} variant='h6'>{editStatus ? 'Edit':'Add'} OEM</Typography>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <Stack spacing={1} p={2}>
                            <Typography variant='subtitle2' color={'primary.contrastText'}>Add Charger OEM</Typography>
                            <StyledInput />
                        </Stack>
                    </Grid>
                </Grid>
