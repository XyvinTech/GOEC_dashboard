        ...
        <Stack direction={'column'} sx={{ backgroundColor: 'secondary.main', borderRadius: '4px', border: '1px solid #fff3' }}>
            ...
            <Stack direction={'column'}>
                <Stack direction={'row'} sx={{ justifyContent: 'space-between',width:'100%',py:1,px:2 }}>
                    ...
                    <Typography  variant='body2' sx={{fontWeight: 300 }}>{data.tarrifName}</Typography>
                </Stack>
                <StyledDivider/>

                <Stack direction={'row'} sx={{ justifyContent: 'space-between',width:'100%',py:1,px:2 }}>
                    <Typography variant='body2' sx={{ color: '#fff5', fontWeight: 300 }} >Location</Typography>
                    <Typography  variant='body2' sx={{fontWeight: 300 }}>{data.Location}</Typography>
                </Stack>
                <StyledDivider/>
                ...
                <Stack direction={'row'} sx={{ justifyContent: 'space-between',width:'100%',py:1,px:2 }}>
                    ...
                    <Typography  variant='body2' sx={{fontWeight: 300 }}>{data.Tax}</Typography>
                </Stack>
                <StyledDivider/>

                <Stack direction={'row'} sx={{ justifyContent: 'space-between',width:'100%',py:1,px:2 }}>
                    <Typography variant='body2' sx={{ color: '#fff5', fontWeight: 300 }} >Service Fee</Typography>
                    <Typography  variant='body2' sx={{fontWeight: 300 }}>{data.serviceFee}</Typography>
                </Stack>
